...
public class QAPRecyclerAdapter extends RecyclerView.Adapter<QAPRecyclerAdapter.ListViewHolder> {
    ...
    // LOGGING VARIABLES
    private static final String LOG_TAG = QAPRecyclerAdapter.class.getSimpleName();

    /** INITIALIZATION METHODS _________________________________________________________________ **/

    // QAPRecyclerAdapter(): Constructor method.
    public QAPRecyclerAdapter(List<Datum> list, Activity act){
        this.activity = act;
        this.postList = list;
    }
    ...
    public void onBindViewHolder(ListViewHolder holder, int position) {
        ...
        Log.d(LOG_TAG, "onBindViewHolder(): Poster Name: " + postList.get(position).getUser().getName());
        Log.d(LOG_TAG, "onBindViewHolder(): Text Description: " + postList.get(position).getText());
        Log.d(LOG_TAG, "onBindViewHolder(): Time created at: " + postList.get(position).getCreatedAt());
