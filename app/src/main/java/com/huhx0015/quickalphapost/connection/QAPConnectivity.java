package com.huhx0015.quickalphapost.connection;
...
public class QAPConnectivity {
    ...
    // LOGGING VARIABLES
    private static final String LOG_TAG = QAPConnectivity.class.getSimpleName();
    ...
    public static Boolean checkConnectivity(Context context) {
        ...
        if (info != null) {
            ...
            try {
                ...
                InetAddress ipAddr = InetAddress.getByName("api.app.net");
